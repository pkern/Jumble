...
JNIEXPORT jint JNICALL Java_com_morlunk_jumble_audio_javacpp_RNNoise_rnnoise_1get_1size(JNIEnv* env, jclass cls) {
    jint rarg = 0;
    jthrowable exc = NULL;
    try {
        int rval = rnnoise_get_size();
        rarg = (jint)rval;
    } catch (...) {
...
JNIEXPORT jint JNICALL Java_com_morlunk_jumble_audio_javacpp_RNNoise_rnnoise_1init(JNIEnv* env, jclass cls, jobject arg0) {
    ...
    jthrowable exc = NULL;
    try {
        int rval = rnnoise_init((DenoiseState *)ptr0);
        rarg = (jint)rval;
    } catch (...) {
        exc = JavaCPP_handleException(env, 6);
    }
...
JNIEXPORT jobject JNICALL Java_com_morlunk_jumble_audio_javacpp_RNNoise_rnnoise_1create(JNIEnv* env, jclass cls) {
    jobject rarg = NULL;
    void* rptr;
    jthrowable exc = NULL;
    try {
...
JNIEXPORT void JNICALL Java_com_morlunk_jumble_audio_javacpp_RNNoise_rnnoise_1destroy(JNIEnv* env, jclass cls, jobject arg0) {
    char* ptr0 = arg0 == NULL ? NULL : (char*)jlong_to_ptr(env->GetLongField(arg0, JavaCPP_addressFID));
    jlong position0 = arg0 == NULL ? 0 : env->GetLongField(arg0, JavaCPP_positionFID);
    ptr0 += position0;
    jthrowable exc = NULL;
    try {
        rnnoise_destroy((DenoiseState *)ptr0);
    } catch (...) {
        exc = JavaCPP_handleException(env, 6);
    }
...
JNIEXPORT jfloat JNICALL Java_com_morlunk_jumble_audio_javacpp_RNNoise_rnnoise_1process_1frame(JNIEnv* env, jclass cls, jobject arg0, jfloatArray arg1, jfloatArray arg2) {
    char* ptr0 = arg0 == NULL ? NULL : (char*)jlong_to_ptr(env->GetLongField(arg0, JavaCPP_addressFID));
    jlong position0 = arg0 == NULL ? 0 : env->GetLongField(arg0, JavaCPP_positionFID);
    ptr0 += position0;
    ...
    jthrowable exc = NULL;
    try {
        float rval = rnnoise_process_frame((DenoiseState *)ptr0, (float *)ptr1, (const float *)ptr2);
        rarg = (jfloat)rval;
    } catch (...) {
        exc = JavaCPP_handleException(env, 6);
    }
    ...
    if (arg2 != NULL) env->ReleaseFloatArrayElements(arg2, (jfloat*)ptr2, JNI_ABORT);
    if (exc != NULL) {
        env->Throw(exc);
    }
    return rarg;
